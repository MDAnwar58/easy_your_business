...
import '@/Assets/Backend/js/sidebar.js';
import ChartContext from '@/Assets/Backend/js/charts.js';
// import '@/Assets/Backend/js/charts.js';
import Iphone from '@/Assets/Backend/img/images/products/iphone.png'
import { Head } from '@inertiajs/react';


const Dashboard = () => {
    const { getAllCharts } = ChartContext();
                                    ...
                                    <li className="py-3 sm:py-4">
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center min-w-0">
                                                <img className="flex-shrink-0 w-10 h-10" src={Iphone} alt="imac image" />
                                                <div className="ml-3">

...
import avatar from '@/Assets/Frontend/images/avatars/avatar.webp'
import avatar1 from '@/Assets/Frontend/images/avatars/avatar-1.webp'
import avatar2 from '@/Assets/Frontend/images/avatars/avatar-2.webp'
import avatar3 from '@/Assets/Frontend/images/avatars/avatar-3.webp'
import avatar4 from '@/Assets/Frontend/images/avatars/avatar-4.webp'
                ...
                <div className="md:columns-2 lg:columns-3 gap-8 space-y-8">
                    <div className="aspect-auto p-8 border border-gray-100 rounded-3xl bg-white dark:bg-gray-800 dark:border-gray-700 shadow-2xl shadow-gray-600/10 dark:shadow-none">
                        <div className="flex gap-4">
                            <img className="w-12 h-12 rounded-full" src={avatar} alt="user avatar" width={400} height={400} loading="lazy" />
                            <div>
                    ...
                    <div className="aspect-auto p-8 border border-gray-100 rounded-3xl bg-white dark:bg-gray-800 dark:border-gray-700 shadow-2xl shadow-gray-600/10 dark:shadow-none">
                        <div className="flex gap-4">
                            <img className="w-12 h-12 rounded-full" src={avatar1} alt="user avatar" width={200} height={200} loading="lazy" />
                            <div>
                    ...
                    <div className="aspect-auto p-8 border border-gray-100 rounded-3xl bg-white dark:bg-gray-800 dark:border-gray-700 shadow-2xl shadow-gray-600/10 dark:shadow-none">
                        <div className="flex gap-4">
                            <img className="w-12 h-12 rounded-full" src={avatar2} alt="user avatar" width={200} height={200} loading="lazy" />
                            <div>
                    ...
                    <div className="aspect-auto p-8 border border-gray-100 rounded-3xl bg-white dark:bg-gray-800 dark:border-gray-700 shadow-2xl shadow-gray-600/10 dark:shadow-none">
                        <div className="flex gap-4">
                            <img className="w-12 h-12 rounded-full" src={avatar3} alt="user avatar" width={200} height={200} loading="lazy" />
                            <div>
                                <h6 className="text-lg font-medium text-gray-700 dark:text-white">Jane Doe</h6>
                                <p className="text-sm text-gray-500 dark:text-gray-300">Mobile dev</p>
                            </div>
                    ...
                    <div className="aspect-auto p-8 border border-gray-100 rounded-3xl bg-white dark:bg-gray-800 dark:border-gray-700 shadow-2xl shadow-gray-600/10 dark:shadow-none">
                        <div className="flex gap-4">
                            <img className="w-12 h-12 rounded-full" src={avatar4} alt="user avatar" width={200} height={200} loading="lazy" />
                            <div>
                    ...
                    <div className="aspect-auto p-8 border border-gray-100 rounded-3xl bg-white dark:bg-gray-800 dark:border-gray-700 shadow-2xl shadow-gray-600/10 dark:shadow-none">
                        <div className="flex gap-4">
                            <img className="w-12 h-12 rounded-full" src={avatar2} alt="user avatar" width={400} height={400} loading="lazy" />
                            <div>

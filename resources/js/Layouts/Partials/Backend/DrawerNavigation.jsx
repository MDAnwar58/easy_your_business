...
const DrawerNavigation = () => {
    const ActiveLink = 'bg-gray-100';
    return (
        <div id="drawer-navigation" className="lg:hidden fixed top-0 left-0 z-40 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-white w-64 dark:bg-gray-800" tabIndex={-1} aria-labelledby="drawer-navigation-label">
            ...
            <div className="py-4 overflow-y-auto">
                <ul className="space-y-2 font-medium">
                    ...
                    <li>
                        <Link href={route('admin.dashboard')} className={`flex items-center p-2 text-gray-900 rounded-lg dark:text-white ${route('admin.dashboard') && ActiveLink} hover:bg-gray-100 dark:hover:bg-gray-700 group`}>

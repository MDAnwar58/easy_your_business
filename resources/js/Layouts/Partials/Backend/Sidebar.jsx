...
const Sidebar = ({ ziggy }) => {
    const { url } = usePage();
    const ActiveLink = 'bg-gray-100 dark:text-gray-200';
    return (
        <aside id="sidebar" className="fixed top-0 left-0 z-20 flex flex-col flex-shrink-0 hidden w-64 h-full pt-16 font-normal duration-75 lg:flex transition-width" aria-label="Sidebar">
            <div className="relative flex flex-col flex-1 min-h-0 pt-0 bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                <div className="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
                    <div className="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                        <ul className="pb-2 space-y-2"> 
                            <li>
                                <Link href={route('admin.dashboard')} className={`flex items-center p-2 text-base text-gray-900 rounded-lg ${url === '/admin/dashboard' && ActiveLink} hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700`}>
                            ...
                            <li> 
                                <Link href={route('admin.store.type')} className={`flex items-center p-2 text-base text-gray-900 rounded-lg ${url === '/admin/store-type' && ActiveLink} hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700`}>
                                    ...
                                    <span className="ml-3" sidebar-toggle-item="true">Store Type</span>
                                </Link>
                            </li>
                            <li>
                                ...
                                <ul id="dropdown-layouts" className="hidden py-2 space-y-2">
                                    <li>
                                        <a href className="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Stacked</a>
                                    </li>
                                    <li>
                            ...
                            <li>
                                ...
                                <ul id="dropdown-crud" className="space-y-2 py-2 hidden">
                                    <li>
                                        <a href="" className="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 bg-gray-100 dark:bg-gray-700">Products</a>
                                    </li>
                                    <li>
                                        <a href="" className="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 bg-gray-100 dark:bg-gray-700">Users</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                <a href className="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700 bg-gray-100 dark:bg-gray-700">
                                    ...
                                    <span className="ml-3" sidebar-toggle-item="true">Settings</span>
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <ul id="dropdown-playground" className="space-y-2 py-2 hidden">
                                    <li>
                                        <a href className="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 bg-gray-100 dark:bg-gray-700">Stacked</a>
                                    </li>
                                    <li>
                                        <a href className="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 bg-gray-100 dark:bg-gray-700">Sidebar</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                ...
                <div className="absolute bottom-0 left-0 justify-center hidden w-full p-4 space-x-4 bg-white lg:flex dark:bg-gray-800" sidebar-bottom-menu="true">
                    ...
                    <button type="button" id="language-dropdown" data-dropdown-toggle="dropdown" className="inline-flex justify-center p-2 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white">
